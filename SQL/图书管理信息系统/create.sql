...
create table book
(
书籍编号 int primary key,
书籍名称 char(50), 
书籍类别  int foreign key references book_cate(类别编号), 
作者名称 char(50) ,
出版社名称 char(50),
出版日期 datetime,
书籍页码 int,
...
读者姓名 char(10),
读者种类 int foreign key references reader_cate(种类编号),
读者性别 char (4),
工作单位 char(50),
家庭地址 char(50),
电话号码 char(11),
...
读者编号 int foreign key references reader(读者编号),
书籍编号 int foreign key references book(书籍编号),
